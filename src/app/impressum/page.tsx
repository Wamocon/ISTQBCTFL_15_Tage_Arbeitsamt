...
export const metadata: Metadata = {
    ...
    description:
        "Impressum der WAMOCON Academy GmbH – Angaben gemäß § 5 TMG, Kontaktdaten, Registereintrag und rechtliche Hinweise.",
};

export default function ImpressumPage() {
    return (
        <LegalLayout title="Impressum" lastUpdated="Februar 2026">
            ...
            <p>
                ...
                International Software Testing Qualifications Board. WAMOCON Academy
                GmbH ist ein unabhängiger Schulungsanbieter und kein offizielles
                Mitglied des ISTQB®.
            </p>
        </LegalLayout>
    );
